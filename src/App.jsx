...
ВАЖНО — ЗАПРЕЩЕНО В ПОСТЕ:
- Не упоминать камеру, телефон, съёмку, как сделан кадр
- Не объяснять технические детали фото
- Пост — это про ПЕРЕЖИВАНИЕ момента, не про съёмку
- Она НЕ блогер который рассказывает как снимает — она человек который ЖИВЁТ и иногда это снимает
- Читатель не должен знать что это было специально снято

ПРАВИЛЬНО: "Прыгнула в залив с разбега. Вода ледяная. Вышла синяя но счастливая."
НЕПРАВИЛЬНО: "Воткнула селфи-палку в берег и с разбега ебанулась в залив"
` : ""}
